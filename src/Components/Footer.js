...
function Footer() {
  ...
  return (
    <footer className="bg-slate-100 dark:bg-slate-900 text-slate-600 dark:text-slate-300 py-12 border-t border-slate-200 dark:border-slate-800">
      <div className="container mx-auto px-6 lg:px-12 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-12">
          
          {/* Brand Info */}
          <div className="md:col-span-4 flex flex-col items-start">
            <Link to="/" className="inline-block mb-6 bg-white dark:bg-white rounded-lg p-2">
          ...
          <div className="md:col-span-3">
            <h4 className="text-slate-900 dark:text-white font-semibold mb-6">Reach Out to Us</h4>
            <ul className="space-y-4 text-sm text-slate-500 dark:text-slate-400">
              <li className="flex items-start gap-3">
                <Mail className="w-5 h-5 text-orange-500 shrink-0" />
                <a href="mailto:contact@rakshakservice.com" className="hover:text-slate-900 dark:hover:text-white transition-colors">
        ...
        {/* Bottom Bar */}
        <div className="pt-8 border-t border-slate-200 dark:border-slate-800 text-center md:text-left flex flex-col md:flex-row justify-between items-center text-sm text-slate-500">
