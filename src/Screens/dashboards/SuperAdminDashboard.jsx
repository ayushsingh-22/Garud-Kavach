...
import { ShieldAlert, Users, ClipboardList, LayoutDashboard, FileText, Activity, MapPin, Map } from 'lucide-react';
...
const SuperAdminDashboard = () => {
    ...
    useEffect(() => {
        const fetchStats = async () => {
            try {
                const [queriesRes, guardsRes, staffRes] = await Promise.all([
